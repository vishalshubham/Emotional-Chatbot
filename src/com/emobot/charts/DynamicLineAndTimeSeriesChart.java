...
public class DynamicLineAndTimeSeriesChart extends ApplicationFrame implements ActionListener {
    ...
    public DynamicLineAndTimeSeriesChart(final String title) {
        ...
        super(title);
        this.series0 = new TimeSeries("E Value", Millisecond.class);
        this.series1 = new TimeSeries("P Value", Millisecond.class);
        this.series2 = new TimeSeries("A Value", Millisecond.class);
       
        final TimeSeriesCollection dataset = new TimeSeriesCollection(this.series0);
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        this.series0.add(new Millisecond(), this.lastValue);
        this.series1.add(new Millisecond(), 100);
        this.series2.add(new Millisecond(), this.lastValue-50);
