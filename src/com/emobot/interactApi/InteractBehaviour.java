...
public class InteractBehaviour {
	...
	public static EPANode getEPAValues(String behaviour){
		...
		case "agree with": return new EPANode(1.35, 0.58, 0.74);
		...
		case "apologize to": return new EPANode(1.86, 1.12, 0.08);
		case "appeal to": return new EPANode(1.63, 0.28, 0.96);
		...
		case "approve of": return new EPANode(1.66, 0.9, -0.03);
		...
		case "chatter to": return new EPANode(0.8, -0.11, 0.59);
		...
		case "confide in": return new EPANode(1.7, 0.57, -0.07);
		...
		case "dance with": return new EPANode(1.74, 0.87, 1.19);
		case "dare": return new EPANode(0.22, 0.8, 0.74);
		case "dazzle": return new EPANode(1.5, 1.18, 1.22);
		case "debate with": return new EPANode(0.88, 0.59, 0.5);
		...
		case "disagree with": return new EPANode(0.02, 0.75, 0.5);
		...
		case "discriminate against": return new EPANode(-2.14, 0.68, -0.91);
		...
		case "freak out": return new EPANode(-0.88, 0.4, 0.36);
		...
		case "grieve for": return new EPANode(-0.23, 0.39, -0.23);
		...
		case "laugh with": return new EPANode(2.02, 0.99, 0.43);
		...
		case "listen to": return new EPANode(2.11, 0.88, -0.15);
		case "loathe": return new EPANode(-1.49, 0.25, 0.25);
		case "look at": return new EPANode(1.18, 0.52, 0.22);
		...
		case "negotiate with": return new EPANode(1.48, 1.36, 0.27);
		...
		case "play with": return new EPANode(1.41, 0.47, 1.29);
		case "please": return new EPANode(2.01, 1.21, 0.45);
		case "plot against": return new EPANode(-1.38, 0.84, -0.18);
		...
		case "pray for": return new EPANode(1.53, 0.63, -0.62);
		...
		case "quarrel with": return new EPANode(-1.02, 0.4, 0.41);
		...
		case "rebel against": return new EPANode(0.52, 1.27, 1.13);
		...
		case "sing to": return new EPANode(1.72, 0.79, 0.63);
		case "sit next to": return new EPANode(0.98, -0.13, 0.13);
		case "slay": return new EPANode(-2.23, 1.23, 0.69);
		case "sleep with": return new EPANode(1.98, 1.07, 1.09);
		case "slight": return new EPANode(-0.4, 0.05, 0.49);
		case "smile at": return new EPANode(2.08, 0.88, 0.77);
		...
		case "speak to": return new EPANode(1.83, 0.67, 0.57);
		...
		case "steal from": return new EPANode(-2.08, 0.4, 0.24);
		...
		case "submit to": return new EPANode(-0.72, -0.69, -0.52);
		...
		case "talk to": return new EPANode(1.46, 0.31, 0.01);
